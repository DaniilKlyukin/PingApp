...
namespace PingApp
{
    public partial class MainForm : Form
    {
        ...
        private async void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Ћшибка при обновлении статистики: {ex.Message}",
                    "Ћшибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void SaveToFile()
        {
            ...
            {
                MessageBox.Show($"Ћшибка при сохранении файла: {ex.Message}",
                    "Ћшибка сохранениЯ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
